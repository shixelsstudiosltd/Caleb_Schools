<div class="leftmenu">        
    <ul class="nav nav-tabs nav-stacked">
        <li class="active"><a href="#"><span class="iconfa-home"></span>Guardian Dashboard</a></li>
         
    <li class="dropdown"><a href="#"><span class="iconfa-book"></span> Courses</a>
            <ul>
                <li><?php echo CHtml::link('View child Courses',array('')); ?></li>          
        ...
        <li><a href="#"><span class="iconfa-cog"></span> Attendance</a>
          ...
          <li class="dropdown"><a href="#"> <span class="iconfa-book"></span> Assignments</a>
           ...
           <li>
               <?php echo CHtml::link('View Student Assignments',array('')); ?>
           </li>
            </ul>
            </li>
