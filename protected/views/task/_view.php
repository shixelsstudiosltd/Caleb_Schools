...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_given')); ?>:</b>
	<?php echo CHtml::encode($data->date_given); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('taskcol')); ?>:</b>
	<?php echo CHtml::encode($data->taskcol); ?>
	<br />
