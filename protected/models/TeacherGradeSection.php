...
/**
 * This is the model class for table "teacher_grade_section".
 *
 * The followings are the available columns in table 'teacher_grade_section':
 * @property integer $id
 ...
 */
class TeacherGradeSection extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('teacher_teacher_id, course_id, grade_section_id', 'required'),
			array('teacher_teacher_id, course_id, createby, grade_section_id', 'numerical', 'integerOnly'=>true),
			array('timestamp, update_date, create_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, teacher_teacher_id, course_id, timestamp, createby, update_date, create_time, grade_section_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TeacherGradeSection the static model class
	 */
